...
class RayPPOTrainer:
    ...
    def _validate(self):
        ...
        for test_data in self.val_dataloader:
            ...
            test_batch.meta_info["global_steps"] = self.global_steps  # NOTE: to add global steps to trace
    ...
    def fit(self):
        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                batch.meta_info["global_steps"] = self.global_steps  # NOTE: to add global steps to trace
